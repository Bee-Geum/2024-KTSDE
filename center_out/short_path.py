...
def calculate(tup):
    city, num, sample_list, G, k, option = tup
    ...
    with open(f'./shortest_paths/{city}_{option}_sp_{num}_{k}.pkl', 'wb') as file1:
        pickle.dump(sps, file1)


def main(k, txt_file, option):
    ...
    for city in cities:
        ...
        for num in sample_num:
            ...
            file_infos.append((city, num, sample_list, graph, k, option))
